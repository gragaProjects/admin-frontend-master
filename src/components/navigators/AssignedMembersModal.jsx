...
import { FaTimes, FaUserCircle, FaSearch, FaSpinner } from 'react-icons/fa'
        ...
        <div className="flex justify-between items-center mb-6">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">
              Navigator: {navigator.name} • Total Members: {totalCount}
            </p>
          </div>
