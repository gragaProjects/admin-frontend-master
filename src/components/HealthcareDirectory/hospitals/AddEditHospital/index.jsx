...
//         }
//       } else {
//         throw new Error(response?.message || (isEditing ? 'Failed to update doctor' : 'Failed to add data'));
//       }
//     } catch (error) {
...
//         : error.message || 'Failed to add data. Please try again.';
...
//               disabled={isSubmitting}
//             >
//               {isSubmitting ? 'Adding...' : (isEditing ? 'Save Changes' : 'Add Hospital')}
//             </button>
//           </div>
//         </form>
//       </div>
...
const AddEditHospital = ({ onClose, initialData, isEditing, onSuccess }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50"
      ...
      <div className="bg-white rounded-xl p-6 lg:p-8 w-[95%] max-w-5xl mx-4 max-h-[90vh] overflow-y-auto"
        onClick={(e) => e.stopPropagation()}>
