...
import { FaPlus,FaUserMd ,FaTrash, FaEdit, FaTimes, FaUserCircle, FaSearch, FaDownload } from 'react-icons/fa'
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 gap-4 lg:gap-6">
          {doctors.map((doctor) => (
            ...
            <ConfirmationDialog
              ...
              message="Are you sure you want to delete this diagnostics? This action cannot be undone."
