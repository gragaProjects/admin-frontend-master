...
const handleServiceTypeChange = (type) => {
  setFormData(prev => {
    ...
    if (type === "homeVisit") {
      return {
        ...
        homeVisitEnabled: !isSelected
      };
    }

    // Online/Offline Time Slots Handling
  ...
  if (type === 'online') {
    setOnlineTimeSlots(prev =>
      prev.length > 0 ? [] : [{ day: 'monday', slots: [] }]
    );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const data = {
        ...
        homeVisitEnabled: formData.homeVisitEnabled,
homeVisitLocations: formData.homeVisitLocations,
    ...
    >
      ...
      >
        ...
        <DepartmentServiceSection formData={formData} setFormData={setFormData} />
          ...
          {formData.serviceTypes.includes("homeVisit") && (
            <HomeVisitSection 
              formData={formData}
